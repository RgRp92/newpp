...
SESSION_CONFIGS = [
    ...
    dict(
        ...
        num_demo_participants=1,
        app_sequence=['Fase1SF', 'Fase2SF', 'FinalPaymentSF']
    ),
    dict(
        name='Fase2SF',
    ...
    dict(
        ...
        num_demo_participants=1,
        app_sequence=['Fase1SF','Fase3SF', 'FinalPaymentSF']
    ),
    dict(
        name='Fase4',
        display_name="Fase4",
    ...
    dict(
        name='StudioSF',
        display_name="StudioSF",
        num_demo_participants=2,
        app_sequence=['Intro', 'Fase1SF', 'Fase2SF', 'Fase3SF', 'Fase4', 'FinalPaymentSF']
     ),
