...
class Player(BasePlayer):
    ...
    def vars_for_template(self):
        ...
        isttot_r1 = (Constants.ist[0] + inspremist + insvalueist)
        isttot_r2 = (Constants.ist[1] + inspremist + insvalueist)
        isttot_r3 = (Constants.ist[2] + inspremist + insvalueist)
        isttot_r4 = (Constants.ist[3] + inspremist + insvalueist)
        isttot_r5 = (Constants.ist[4] + inspremist + insvalueist)
        isttot_r6 = (Constants.ist[5] + inspremist + insvalueist)
        isttot_r7 = (Constants.ist[6] + inspremist + insvalueist)
        isttot_r8 = (Constants.ist[7] + inspremist + insvalueist)
        isttot_r9 = (Constants.ist[8] + inspremist + insvalueist)
        isttot_r10 = (Constants.ist[9] + inspremist + insvalueist)
        isttot_r11 = (Constants.ist[10] + inspremist + insvalueist)
        isttot_r12 = (Constants.ist[11] + inspremist + insvalueist)

        farmercost_1r = (isttot_r1 - disctot)
        farmercost_2r = (isttot_r2 - disctot)
        farmercost_3r = (isttot_r3 - disctot)
        farmercost_4r = (isttot_r4 - disctot)
        farmercost_5r = (isttot_r5 - disctot)
        farmercost_6r = (isttot_r6 - disctot)
        farmercost_7r = (isttot_r7 - disctot)
        farmercost_8r = (isttot_r8 - disctot)
        farmercost_9r = (isttot_r9 - disctot)
        farmercost_10r = (isttot_r10 - disctot)
        farmercost_11r = (isttot_r11 - disctot)
        farmercost_12r = (isttot_r12 - disctot)
